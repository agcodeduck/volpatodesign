...
DOMAIN_NAME="volpatodesign.com.br" # replace with your own
EMAIL="felipe@codeduck.com.br" # replace with your own

# Script Vars
REPO_URL="https://github.com/agcodeduck/volpatodesign.git"
APP_DIR=~/myapp
